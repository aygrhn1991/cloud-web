...
@Component({
  selector: 'app-oem-speed-duration-year',
  templateUrl: './oem-speed-duration-year.component.html',
  styleUrls: ['./oem-speed-duration-year.component.css']
})
export class OemSpeedDurationYearComponent implements OnInit {
  ...
  makeChartData(data) {
    ...
    this.chartOption = this.chartService.makeReportChart2('车速-时长', y1, x);
  }
