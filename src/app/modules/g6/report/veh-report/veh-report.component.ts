...
export class VehReportComponent implements OnInit {
  ...
  getData() {
    ...
    if (this.time == 'month') {
      this.http.g6Report4(this.util.parameterTransfer(this.searchModel.vid, -1), this.dateStart, this.dateEnd).subscribe((data: Result2) => {
        let x = [];
        let y1 = [];
        let y2 = [];
        let y3 = [];
      ...
      this.http.g6Report6(this.util.parameterTransfer(this.searchModel.vid, -1), this.dateStart, this.dateEnd).subscribe((data: Result2) => {
        let x = [];
        let y1 = [];
        let y2 = [];
        let y3 = [];
      ...
      this.http.g6Report5(this.util.parameterTransfer(this.searchModel.vid, -1), this.dateStart, this.dateEnd).subscribe((data: Result2) => {
        let x = [];
        let y1 = [];
        let y2 = [];
        let y3 = [];
      ...
      this.http.g6Report7(this.util.parameterTransfer(this.searchModel.vid, -1), this.dateStart, this.dateEnd).subscribe((data: Result2) => {
        let x = [];
        let y1 = [];
        let y2 = [];
        let y3 = [];
    ...
    this.http.g6Report8(this.util.parameterTransfer(this.searchModel.vid, -1), this.dateStart, this.dateEnd).subscribe((data: Result2) => {
      let x = [];
      let y1 = [];
      data.data.data.forEach(e => {
        x.push(e.C_SPD);
    ...
    this.http.g6Report10(this.util.parameterTransfer(this.searchModel.vid, -1), this.dateStart, this.dateEnd).subscribe((data: Result2) => {
      let x = [];
      let y1 = [];
      data.data.data.forEach(e => {
        x.push(e.C_SPD);
