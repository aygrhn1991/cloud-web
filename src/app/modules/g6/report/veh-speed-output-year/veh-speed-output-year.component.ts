...
@Component({
  selector: 'app-veh-speed-output-year',
  templateUrl: './veh-speed-output-year.component.html',
  styleUrls: ['./veh-speed-output-year.component.css']
})
export class VehSpeedOutputYearComponent implements OnInit {
