    ...
    let g6MenuList: Array<MenuModel> = [
      ...
      },
      {
        title: '车辆报告', path: null, selected: false, active: false, show: true, pages: [
          ...
          { title: '单车-车速-油耗', path: '/g6/report/veh-speed-fuel', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-百公里油耗差值', path: '/g6/report/veh-speed-fuel-diff', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-排放', path: '/g6/report/veh-speed-output', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-百公里排放差值', path: '/g6/report/veh-speed-output-diff', selected: false, active: false, show: true, pages: [] },

          { title: '主机厂-车速-时长', path: '/g6/report/oem-speed-duration', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-里程', path: '/g6/report/oem-speed-mile', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-油耗', path: '/g6/report/oem-speed-fuel', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-排放', path: '/g6/report/oem-speed-output', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-工况明细', path: '/g6/report/oem-condition', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-工况汇总', path: '/g6/report/oem-condition-sum', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-怠速停车', path: '/g6/report/oem-idling', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-故障码密度', path: '/g6/report/oem-fault', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-百公里均值', path: '/g6/report/oem-average-report', selected: false, active: false, show: true, pages: [] },
        ]
      },
      {
