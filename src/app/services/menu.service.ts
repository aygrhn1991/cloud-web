    ...
    let g6MenuList: Array<MenuModel> = [
      ...
      },
      {
        title: '车辆报告', path: null, selected: false, active: false, show: true, pages: [
          ...
          { title: '单车-怠速停车（年）', path: '/g6/report/veh-idling-year', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-油耗（月）', path: '/g6/report/veh-speed-fuel', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-油耗（年）', path: '/g6/report/veh-speed-fuel-year', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-百公里油耗差值', path: '/g6/report/veh-speed-fuel-diff', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-排放（月）', path: '/g6/report/veh-speed-output', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-排放（年）', path: '/g6/report/veh-speed-output-year', selected: false, active: false, show: true, pages: [] },
          { title: '单车-车速-百公里排放差值', path: '/g6/report/veh-speed-output-diff', selected: false, active: false, show: true, pages: [] },

          { title: '主机厂-车速-时长（月）', path: '/g6/report/oem-speed-duration', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-时长（年）', path: '/g6/report/oem-speed-duration-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-里程（月）', path: '/g6/report/oem-speed-mile', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-里程（年）', path: '/g6/report/oem-speed-mile-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-油耗（月）', path: '/g6/report/oem-speed-fuel', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-油耗（年）', path: '/g6/report/oem-speed-fuel-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-排放（月）', path: '/g6/report/oem-speed-output', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-车速-排放（年）', path: '/g6/report/oem-speed-output-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-工况明细（月）', path: '/g6/report/oem-condition', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-工况明细（年）', path: '/g6/report/oem-condition-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-工况汇总（月）', path: '/g6/report/oem-condition-sum', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-工况汇总（年）', path: '/g6/report/oem-condition-sum-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-怠速停车（月）', path: '/g6/report/oem-idling', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-怠速停车（年）', path: '/g6/report/oem-idling-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-故障码密度（月）', path: '/g6/report/oem-fault', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-故障码密度（年）', path: '/g6/report/oem-fault-year', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-百公里均值（月）', path: '/g6/report/oem-average-report', selected: false, active: false, show: true, pages: [] },
          { title: '主机厂-百公里均值（年）', path: '/g6/report/oem-average-report-year', selected: false, active: false, show: true, pages: [] },
        ]
      },
      {
